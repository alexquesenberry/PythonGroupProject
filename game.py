...
def draw(canvas):
	...
	# Draws Paddle
	pygame.draw.polygon(canvas, GREEN, [	[pad.pos[0] - HALF_PAD_WIDTH, pad.pos[1] - HALF_PAD_HEIGHT], 
						[pad.pos[0] - HALF_PAD_WIDTH, pad.pos[1] + HALF_PAD_HEIGHT], 
						[pad.pos[0] + HALF_PAD_WIDTH, pad.pos[1] + HALF_PAD_HEIGHT], 
						[pad.pos[0] + HALF_PAD_WIDTH, pad.pos[1] - HALF_PAD_HEIGHT]], 0)
	# Update paddle position
	if pad.pos[0] > HALF_PAD_WIDTH + WIDTH/20 and pad.pos[0] < WIDTH - HALF_PAD_WIDTH - WIDTH/20:
		pad.pos[0] += pad.vel
	elif pad.pos[0] == HALF_PAD_WIDTH + WIDTH/20 and pad.vel > 0:
		pad.pos[0] += pad.vel
	elif pad.pos[0] == WIDTH - HALF_PAD_WIDTH - WIDTH/20 and pad.vel < 0:
		pad.pos[0] += pad.vel
